...
const RUBRIC: {
...
}[] = [
  {
    ...
    looksLike: 'Kamera mati, tidak hadir, atau sama sekali diam, atau tidak ikut satu sesi.',
    contribution: 'Tidak ada.',
  },
  {
    score: 1,
    dot: 'bg-chart-4',
    title: 'Partisipasi Minim',
    looksLike: 'Kamera nyala, tapi kebanyakan cuma menonton.',
    contribution: 'Mengulang apa yang dikatakan orang lain, komentar di luar topik, atau menunjukkan kurang paham.',
  },
  {
    score: 2,
    dot: 'bg-brand',
    title: 'Partisipasi Memuaskan',
    looksLike: 'Kamera nyala, hadir, dan siap.',
    contribution:
      'Menjawab pertanyaan dengan benar, tapi sangat bergantung pada catatan/bacaan tanpa banyak pemikiran sendiri.',
  },
  {
    score: 3,
    dot: 'bg-brand-green',
    title: 'Partisipasi Sangat Baik',
    looksLike: 'Kamera nyala dan sangat terlibat sepanjang sesi.',
    contribution:
      'Berbagi ide orisinal, mengaitkan topik dengan kehidupan nyata atau pelayanan, dan membantu mendorong diskusi kelompok maju.',
  },
]
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="bg-muted/40 rounded-md border p-3 text-sm">
        <p className="mb-2 font-medium">Panduan skor Contribution</p>
